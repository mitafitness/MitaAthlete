...
public class AppHelper {
     ...
     */
    private static final String userPoolId = "ap-south-1_c7FYn6HHl";

    /**
     * Add you app id
     */
    private static final String clientId = "6c5aq7s5c1tdu7p1b0g7s037vd";
     ...
     */
    private static final String clientSecret = "18ack849pl5qbvh7bf1lfsvog4ceuvp0rso557f04t9hiqgimud2";

    /**
     * Set Your User Pools region.
     * e.g. if your user pools are in US East (N Virginia) then set cognitoRegion = Regions.US_EAST_1.
     */
    private static final Regions cognitoRegion =   Regions.AP_SOUTH_1 ;  //"ap-south-1" ; //Regions.DEFAULT_REGION;
    ...
    private static void setData() {
        ...
        signUpFieldsC2O.put("Mobile Number","phone_number");
